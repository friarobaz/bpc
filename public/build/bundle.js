...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas_1, "class", "svelte-84krlp");
    			add_location(canvas_1, file, 53, 0, 1169);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", "100");
    			add_location(input, file, 54, 0, 1218);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "change", /*refresh*/ ctx[2], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [canvas, size, refresh, canvas_1_binding, input_change_input_handler];
    }
