...
var app = (function () {
    ...
    const drawMouseLayer = (ctx, mouseCoordinates, origin, curve, showGlide = true, showCursorHelper = true) => {
      if (showCursorHelper) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 103, 15, 3438);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "10");
    			attr_dev(input1, "step", "0.1");
    			add_location(input1, file, 104, 15, 3517);
    			attr_dev(input2, "type", "range");
    			attr_dev(input2, "min", "40");
    			attr_dev(input2, "max", "120");
    			add_location(input2, file, 105, 15, 3605);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "max", "1000");
    			add_location(input3, file, 106, 14, 3685);
    			attr_dev(input4, "type", "range");
    			attr_dev(input4, "min", "0");
    			attr_dev(input4, "max", "200");
    			add_location(input4, file, 107, 14, 3765);
    			add_location(br0, file, 108, 12, 3842);
    			add_location(br1, file, 114, 12, 4025);
    			attr_dev(input5, "type", "checkbox");
    			add_location(input5, file, 118, 16, 4124);
    			add_location(div, file, 116, 12, 4057);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input4, "change", /*input4_change_input_handler*/ ctx[29]),
    					listen_dev(input4, "input", /*input4_change_input_handler*/ ctx[29]),
    					listen_dev(input5, "change", /*input5_change_handler_1*/ ctx[30])
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(101:4) {#if showCurveControls}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*showCurveControls*/ ctx[9] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas0, file, 70, 1, 2409);
    			attr_dev(canvas1, "id", "curve");
    			attr_dev(canvas1, "class", "svelte-wzchmf");
    			add_location(canvas1, file, 71, 1, 2462);
    			attr_dev(canvas2, "id", "mouse");
    			attr_dev(canvas2, "class", "svelte-wzchmf");
    			add_location(canvas2, file, 72, 1, 2517);
    			attr_dev(div0, "id", "container");
    			attr_dev(div0, "class", "svelte-wzchmf");
    			add_location(div0, file, 69, 0, 2364);
    			add_location(br0, file, 75, 0, 2581);
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "min", "-300");
    			attr_dev(input0, "max", "200");
    			add_location(input0, file, 79, 21, 2638);
    			add_location(br1, file, 79, 93, 2710);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "-100");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file, 80, 18, 2734);
    			add_location(div1, file, 78, 0, 2610);
    			add_location(br2, file, 82, 4, 2823);
    			add_location(button, file, 83, 4, 2833);
    			add_location(br3, file, 84, 4, 2886);
    			attr_dev(input2, "type", "checkbox");
    			add_location(input2, file, 86, 4, 2942);
    			add_location(br4, file, 87, 4, 2997);
    			attr_dev(input3, "type", "checkbox");
    			add_location(input3, file, 89, 2, 3036);
    			add_location(br5, file, 90, 2, 3092);
    			attr_dev(input4, "type", "checkbox");
    			add_location(input4, file, 92, 2, 3139);
    			add_location(br6, file, 93, 2, 3191);
    			attr_dev(input5, "type", "checkbox");
    			add_location(input5, file, 95, 0, 3223);
    			add_location(br7, file, 96, 0, 3280);
    			attr_dev(input6, "type", "checkbox");
    			add_location(input6, file, 98, 0, 3314);
    			add_location(br8, file, 99, 0, 3372);
    			attr_dev(div2, "id", "controls");
    			attr_dev(div2, "class", "svelte-wzchmf");
    			add_location(div2, file, 76, 0, 2587);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			/*canvas2_binding*/ ctx[16](canvas2);
    			...
    			input3.checked = /*showBestGlide*/ ctx[4];
    			append_dev(div2, t18);
    			append_dev(div2, br5);
    			append_dev(div2, t19);
    			append_dev(div2, input4);
    			input4.checked = /*showGlide*/ ctx[10];
    			append_dev(div2, t20);
    			append_dev(div2, br6);
    			append_dev(div2, t21);
    			append_dev(div2, input5);
    			input5.checked = /*showCursorHelper*/ ctx[11];
    			append_dev(div2, t22);
    			append_dev(div2, br7);
    			append_dev(div2, t23);
    			append_dev(div2, input6);
    			input6.checked = /*showCurveControls*/ ctx[9];
    			append_dev(div2, t24);
    			append_dev(div2, br8);
    			append_dev(div2, t25);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*reset*/ ctx[12], false, false, false),
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*showBestGlide*/ 16) {
    				input3.checked = /*showBestGlide*/ ctx[4];
    			}

    			if (dirty[0] & /*showGlide*/ 1024) {
    				input4.checked = /*showGlide*/ ctx[10];
    			}

    			if (dirty[0] & /*showCursorHelper*/ 2048) {
    				input5.checked = /*showCursorHelper*/ ctx[11];
    			}

    			if (dirty[0] & /*showCurveControls*/ 512) {
    				input6.checked = /*showCurveControls*/ ctx[9];
    			}

    			if (/*showCurveControls*/ ctx[9]) {
    				if (if_block) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(5, gridCanvas.width = CANVAS_WIDTH, gridCanvas);
    		$$invalidate(6, curveCanvas.width = CANVAS_WIDTH, curveCanvas);
    		$$invalidate(7, mouseCanvas.width = CANVAS_WIDTH, mouseCanvas);
    		$$invalidate(5, gridCanvas.height = CANVAS_HEIGHT, gridCanvas);
    		$$invalidate(6, curveCanvas.height = CANVAS_HEIGHT, curveCanvas);
    		$$invalidate(7, mouseCanvas.height = CANVAS_HEIGHT, mouseCanvas);
    		grid = gridCanvas.getContext("2d");
    		$$invalidate(13, curve = curveCanvas.getContext("2d"));
    	...
    	function input3_change_handler() {
    		showBestGlide = this.checked;
    		$$invalidate(4, showBestGlide);
    	}

    	function input4_change_handler() {
    		showGlide = this.checked;
    		$$invalidate(10, showGlide);
    	}

    	function input5_change_handler() {
    		showCursorHelper = this.checked;
    		$$invalidate(11, showCursorHelper);
    	}

    	function input6_change_handler() {
    		showCurveControls = this.checked;
    		$$invalidate(9, showCurveControls);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('gridCanvas' in $$props) $$invalidate(5, gridCanvas = $$props.gridCanvas);
    		if ('curveCanvas' in $$props) $$invalidate(6, curveCanvas = $$props.curveCanvas);
    		if ('mouseCanvas' in $$props) $$invalidate(7, mouseCanvas = $$props.mouseCanvas);
    		if ('grid' in $$props) grid = $$props.grid;
    		if ('curve' in $$props) $$invalidate(13, curve = $$props.curve);
    		...
    		if ('showCurveControls' in $$props) $$invalidate(9, showCurveControls = $$props.showCurveControls);
    		if ('showAllPTV' in $$props) $$invalidate(3, showAllPTV = $$props.showAllPTV);
    		if ('showBestGlide' in $$props) $$invalidate(4, showBestGlide = $$props.showBestGlide);
    		if ('showGlide' in $$props) $$invalidate(10, showGlide = $$props.showGlide);
    		if ('showCursorHelper' in $$props) $$invalidate(11, showCursorHelper = $$props.showCursorHelper);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*curve, curveNumbers, origin, showEntireCurve, showAllPTV, showBestGlide*/ 8223) {
    			if (curve) {
